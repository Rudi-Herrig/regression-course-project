...
popdata[,10:ncol(popdata)] <- as.data.frame(apply(popdata[,10:ncol(popdata)], 2, function(x) (as.numeric(x))))
...
popdata_list <- list(Headers = popdata_head, Data = popdata)
...
library(openxlsx)
write.xlsx(WhiteIlliterate, "WhiteIlliterate.xlsx")
write.xlsx(popdata_list, "popdata.xlsx")
```
